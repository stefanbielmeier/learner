...
ax.plot(x_axis, mem_cap, label='mem_cap', color='cyan')
ax.set_xlabel("number of memories")
ax.set_ylabel("memorization capacity")
ax.legend()

ax2 = ax.twinx()
#ax2.plot(x_axis, info_gain, label='KL divergence')
ax2.plot(x_axis, random_thresholds, label='Uniform Random Thresholds')
