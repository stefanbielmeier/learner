...
train_subset = np.concatenate((train[6000:12000, :-1], train[42000:48000, :-1]))  # 6000 in each class
train_subset_labels = np.array(np.concatenate((train[6000:12000, -1], train[42000:48000, -1])), dtype=np.float64)
